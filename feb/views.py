...
def indexfeb(request):
    return render(request, 'feb-muka.html')
...
def dosenfeb(request):
    if request.POST:
        ...
        if form.is_valid():
            ...
            return render(request, 'dosenfeb.html', konteks)
    else:
        form = FormDosen()
...
def tendikfeb(request):
    if request.POST:
        ...
        if form.is_valid():
            ...
            return render(request, 'tendikfeb.html', konteks)
    else:
        form = FormTendik()
...
def mahasiswafeb(request):
    if request.POST:
        ...
        if form.is_valid():
            ...
            return render(request, 'mahasiswafeb.html', konteks)
    else:
        form = FormMahasiswa()
